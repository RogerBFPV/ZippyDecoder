...
#from LTInterface import READ_REVISION_CODE, READ_MULTINODE_COUNT, MAX_RETRY_COUNT, \
...
def discoverserial(idxOffset, config, isS32BPillFlag=False, *args, **kwargs):
    nodes = []
                ...
                if multi_count <= 1:
                    if multi_count > 0:
                        ...
                        if 'set_info_node_obj_fn' in kwargs:
                            kwargs['set_info_node_obj_fn'](node)  # set 'info_node_obj' in LTInterface
