...
import functools
import traceback
import util.LT_GPIO as LT_GPIO
...
def idAndLogSystemInfo():
    ...
    try:
        ...
        S32_BPill_board_flag = LT_GPIO.check_input_tied_low(RHGPIO_S32ID_PIN)
